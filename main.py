...
if not OPENAI_API_KEY:
    raise RuntimeError(
        "OPENAI_API_KEY n'est pas défini dans l'environnement (ajoute-le dans Koala-backend/.env)."
    )
...
# =========================
# CORS (✅ Web + ✅ Capacitor iOS/Android)
# =========================
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        ...
        # ✅ Capacitor / Ionic (iOS TestFlight / Android)
        "capacitor://localhost",
        "ionic://localhost",

        # Parfois WKWebView utilise aussi localhost "classique"
        "http://localhost",
        "https://localhost",
    ],
